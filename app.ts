const sections = [
  {
    ...
    title: "Les actus",
    description:
      "Retrouvez les entraînements, événements et rendez-vous du collectif.",
  ...
  },
  {
    ...
    description:
      "Une question, une envie de participer ? Échangeons autour du workout.",
  ...
  },
  {
    ...
    title: "Adhésions",
    description:
      "Rejoignez Street Workout Bordeaux et progressez avec la communauté.",
  ...
  },
  {
    ...
    title: "Nos athlètes",
    description:
      "Découvrez celles et ceux qui font vivre le mouvement bordelais.",
...
const cardsMarkup = sections
  .map(
    ({ id, number, title, description, action }) => `
...
const athleteLinksMarkup = (athletes: { handle: string; url: string }[]) =>
  athletes
    .map(
      ({ handle, url }) => `
